...
var api = builder
    ...
    .WithEnvironment("OpenAI__ProjectId", "first10-local")
    .WithEnvironment("OpenAI__Region", "global")
    .WithEnvironment("OpenAI__RetentionMode", "disabled")
    .WithEnvironment("OpenAI__TranscriptionModel", "gpt-4o-transcribe")
    .WithEnvironment("OpenAI__TriageModel", "gpt-5.6-sol")
    .WithEnvironment("OpenAI__CrewBriefingModel", "gpt-5.6-sol")
    .WithEnvironment("OpenAI__ApprovedProfile__ProjectId", "first10-local")
    .WithEnvironment("OpenAI__ApprovedProfile__Region", "global")
    .WithEnvironment("OpenAI__ApprovedProfile__RetentionMode", "disabled")
    .WithEnvironment("OpenAI__ApprovedProfile__TranscriptionModel", "gpt-4o-transcribe")
    .WithEnvironment("OpenAI__ApprovedProfile__TriageModel", "gpt-5.6-sol")
    .WithEnvironment("OpenAI__ApprovedProfile__CrewBriefingModel", "gpt-5.6-sol")
    .WithEnvironment("Infrastructure__AutoProvision", "true")
    .WaitFor(database)
...
builder
    ...
    .WithEnvironment("OpenAI__ApprovedProfile__CrewBriefingModel", "gpt-5.6-sol")
    .WithEnvironment("Infrastructure__AutoProvision", "true")
    .WithEnvironment("Infrastructure__ApplyMigrations", "true")
    .WaitFor(database)
    .WaitFor(objectStorage);
